						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Malang ,Indonesia</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+62 82257392945</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>revanmalang584@gmail.com</a></li>
								</ul>
							</div>
						</div>
